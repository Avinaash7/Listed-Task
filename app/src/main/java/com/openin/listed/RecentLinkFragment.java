 ...
 * Use the {@link RecentLinkFragment#newInstance} factory method to
...
public class RecentLinkFragment extends Fragment {
     ...
     * @return A new instance of fragment RecentLinkFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static RecentLinkFragment newInstance(String param1, String param2) {
        RecentLinkFragment fragment = new RecentLinkFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        verticalrv = v.findViewById(R.id.vertical_rv2);
                ...
                new Response.Listener<String>()
                {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            JSONArray top_links = data.getJSONArray("recent_links");
